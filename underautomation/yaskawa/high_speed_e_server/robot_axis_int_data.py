...
from UnderAutomation.Yaskawa.HighSpeedEServer import RobotAxisIntData as robot_axis_int_data

class RobotAxisIntData(RobotAxisRawData1[int]):
	...
	def __init__(self, _internal = 0):
		if(_internal == 0):
			self._instance = robot_axis_int_data()
		else:
	...
	def __eq__(self, other) -> bool:
		if not isinstance(other, RobotAxisIntData):
			NotImplemented
