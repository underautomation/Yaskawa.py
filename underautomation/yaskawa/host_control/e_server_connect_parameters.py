...
from UnderAutomation.Yaskawa.HostControl import EServerConnectParameters as e_server_connect_parameters
...
class EServerConnectParameters(HostControlConnectParametersBase):
	...
	def __init__(self, _internal = 0):
		...
		if(_internal == 0):
			self._instance = e_server_connect_parameters()
		else:
	...
	def __eq__(self, other) -> bool:
		if not isinstance(other, EServerConnectParameters):
			NotImplemented
...
EServerConnectParameters.DEFAULT_PORT = e_server_connect_parameters.DEFAULT_PORT
